...
.full-diff td.content.deleted, .full-diff td.content.inserted, .s-prose blockquote, .s-prose :not(.s-code-block) > code, .s-prose pre:not(.s-code-block), pre.s-code-block
{
